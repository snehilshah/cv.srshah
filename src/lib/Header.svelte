...
>
	<div
		class="layout-md py-1 flex justify-between items-center border-b border-neutral-300 dark:border-neutral-700"
	>
		<bi
		...
		<nav
			class="flex items-start text-neutral-500 justify-end space-x-4 sm:space-x-6 text-lg py-0.5"
		>
